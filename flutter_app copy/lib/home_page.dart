...
class _HomePageState extends State<HomePage> {
  ...
  */
  ...
  Widget build(BuildContext mainContext) {
    print("is user pro = $isUserPro");
    if (dreamCards.length > 0 &&
        dreamCards.first.runtimeType.toString() == 'GestureDetector') {
      dreamCards.removeAt(0);
    }
    dreamCards.insert(
      0,
      new GestureDetector(
        onTap: () {
          ...
          //TODO: if isUserPro != true and user tries to make more then 2 dreams pop up will appear asking them to go pro
          //TODO: This pop up is is in the user_isnt_pro_alert.dart
          if (isUserPro == true ||
